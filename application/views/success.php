...
<body>
	...
	<section class="text-center section-success" id="tittlepage">
		<h1 class="edit-h1">Data Tersimpan!</h1>
			<span class="text-center success-text">Terima kasih. Formulir Permohonan Anda telah tersimpan di sistem Kami.<br> Nomor Registrasi Anda adalah<br><strong><?php echo $noreg;?></strong>.<br>Mohon Simpan Nomor Registrasi.</span>
