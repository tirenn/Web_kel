			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					...
					<div class="carousel-caption">
                        ...
                        <h2 class="edit-h2 text-center">Terima kasih. Formulir Permohonan Anda telah tersimpan di sistem kami.<br>
						Nomor Registrasi Anda adalah<br><strong> <?php echo $noreg;?></strong>.<br>
						Mohon Simpan Nomor Registrasi.</h2>
					</div>
				</div>
			</div>
